...
<div class="statistics">
  <div class="online">
      ...
      <div class="info">
          <span class="num">Microphone</span>
  ...
  <div class="files">
      <div class="pulse"><div class="wave"></div></div>
      <div class="info">
          <span class="num">Neural Networks</span>
          <small>{nn_details["ww_engine"]} + {nn_details["stt_engine"]}</small>
      </div>
  </div>
  <div class="downloads hint--bottom" aria-label="Total downloads for the entire project">
      <div class="pulse"><div class="wave"></div></div>
      <div class="info">
          <span class="num">Resources</span>
